            ...
            <div className='flex flex-col w-screen h-screen items-center md:justify-center'>
                ...
                <div className="grid grid-cols-1 gap-4 p-6 md:grid-cols-3 md:p-4 md:mx-8 lg:mx-32 text-center">
                    ...
                    <motion.div
                        ...
                        className="p-6 rounded-lg cursor-pointer md:p-1 lg:p-6 hover:border" onClick={handleMorning}>
                    ...
                    <motion.div
                        initial={{ opacity: 0, scale: 0.5 }}
                        animate={{ opacity: 1, scale: 1 }}
                        transition={{ duration: 0.5 }} className="p-6 rounded-lg cursor-pointer md:p-1 lg:p-6 hover:border" onClick={handleAfternoon}>
                    ...
                    <motion.div
                        initial={{ opacity: 0, scale: 0.5 }}
                        animate={{ opacity: 1, scale: 1 }}
                        transition={{ duration: 0.7 }} className="p-6 rounded-lg cursor-pointer md:p-1 lg:p-6 hover:border" onClick={handleNight}>
