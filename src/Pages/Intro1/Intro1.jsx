...
function Intro1() {
  return (
      <>
          {/* Container */}
          <div className='flex flex-col w-screen h-screen items-center justify-center my-4'>
              ...
              <div className="grid grid-cols-1 gap-4 p-6 md:grid-cols-3 md:p-4 md:mx-8 lg:mx-32 text-center">
                  ...
                  <div className="p-6 rounded-lg cursor-pointer md:p-1 lg:p-6 hover:border">
                      ...
                      <button className='antialiased bg-blue-dark rounded-full inline-block p-6 my-4 py-3 text-white'>Select</button>
                  </div>
                  {/* Card 2 */}
