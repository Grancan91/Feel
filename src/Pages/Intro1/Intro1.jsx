            ...
            <div className='flex flex-col w-screen h-screen items-center md:justify-center'>
                ...
                <div className="grid grid-cols-1 gap-4 p-6 md:grid-cols-3 md:p-4 md:mx-8 lg:mx-32 text-center">
                    ...
                    <motion.div
                        ...
                        className="p-6 rounded-lg cursor-pointer md:p-1 lg:p-6 hover:border" onClick={handleDay}>
                    ...
                    <motion.div
                        ...
                        className="p-6 rounded-lg cursor-pointer md:p-1 lg:p-6 hover:border" onClick={handleWeek}>
                    ...
                    <motion.div
                        ...
                        animate={{ opacity: 1, y: 0 }}
                        transition={{ duration: 0.5 }} className="p-6 rounded-lg cursor-pointer md:p-1 lg:p-6 hover:border" onClick={handleMonth}>
