    ...
    return (
        ...
        <>
            <div className='flex bg-white md:rounded-tr-[30px] items-center md:flex-col md:h-screen md:w-32'>
                ...
                <div className='w-fit h-fit p-2 my-0 mx-2 divide-y md:my-6'>
                ...
                {/*'Home Button'*/}
                <Link to={'/home'}>
                <div className={`${home} w-fit h-fit p-2 my-2 mx-2 md:w-fit md:p-4 md:mx-0`}>
                ...
                <Link to={'/record'}>
                {/*'Record Button'*/}
                <div className={`${record} w-fit h-fit p-2 my-2 mx-2 md:w-fit md:p-4 md:mx-0`}>
                    <svg className="w-6 h-6" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20">
                ...
                {/*'Stats Button'*/}
                <div className={`${stats} w-fit h-fit p-2 my-2 mx-2 md:w-fit md:p-4 md:mx-0`}>
                ...
                {/*'Calendar Button'*/}
                <div className={`${diary} w-fit h-fit p-2 my-2 mx-2 md:w-fit md:p-4 md:mx-0`}>
